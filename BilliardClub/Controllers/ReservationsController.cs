...
namespace BilliardClub.Controllers
{
    ...
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ReservationData,TableId,UserId,Description")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
                var existingReservation = await _context.Reservation
                    .Where(r => r.TableId == reservation.TableId && r.ReservationData == reservation.ReservationData)
                    .FirstOrDefaultAsync();

                if (existingReservation != null)
                {
                    ModelState.AddModelError(string.Empty, "A reservation already exists for this table at the specified time.");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ReservationData,TableId,UserId,Description")] Reservation reservation)
        {
