...
namespace BilliardClub.Controllers
{
    ...
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TableId,AvalibePlaces,Smokers")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TableId,AvalibePlaces,Smokers")] Table table)
        {
            if (id != table.TableId)
            {
                return NotFound();
        ...
        {
          return (_context.Table?.Any(e => e.TableId == id)).GetValueOrDefault();
        }
    }
}
